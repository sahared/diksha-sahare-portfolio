...
const Contact = () => {
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      link: "https://wa.me/18574219015?text=Hi%2C%20I%20want%20to%20contact%20you",
    },
  ];
  ...
  return (
    <section
      id="contact"
      className="py-20 px-4 bg-[hsl(23,100%,77%)]/10 relative overflow-hidden border-t border-border/30"
    >
      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="mt-20 text-center">
          <p className="text-sm text-muted-foreground">Build by Diksha Sahare</p>
        </div>
      </div>
    </section>
  );
